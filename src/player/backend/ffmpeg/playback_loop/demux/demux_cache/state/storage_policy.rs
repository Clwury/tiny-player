...
impl DemuxPacketCacheState {
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn resident_limit_bytes(
        &self,
    ) -> usize {
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn media_limits(
        &self,
    ) -> (usize, usize) {
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn storage_memory_full(
        &self,
    ) -> bool {
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn track_packet_storage_insert(
        &mut self,
        id: PacketId,
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn track_packet_storage_remove(
        &mut self,
        id: PacketId,
        packet: &CachedDemuxPacket,
    ) {
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn change_packet_storage(
        &mut self,
        id: PacketId,
    ...
    pub(in crate::player::backend::ffmpeg::playback_loop::demux_cache) fn desired_hot_packets(
        &self,
    ) -> BTreeSet<PacketId> {
