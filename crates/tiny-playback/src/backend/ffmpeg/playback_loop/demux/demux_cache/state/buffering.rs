...
impl DemuxPacketCacheState {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_pause_demux(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn reader_watermark(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn initial_cache_fill_complete(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_readahead_hysteresis(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cached_until_nsecs(
        &self,
    ) -> Option<u64> {
        let active_end = self
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn forward_duration_nsecs(
        &self,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_pause_percent(
        &self,
    ) -> Option<u8> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_pause_forward_duration_nsecs(
        &self,
    ) -> u64 {
        self.active_stream_forward_windows()
            .into_iter()
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_pause_target_covered(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_pause_can_enter(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_pause_recovered(
        &self,
    ) -> bool {
        self.effective_eof()
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn mark_eof(&mut self) {
        self.seeking = false;
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn effective_eof(&self) -> bool {
        self.read_range_eof()
