...
impl DemuxPacketCacheState {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn take_packet_round_robin(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn take_packet_round_robin_with_trim(
        &mut self,
        stream_indices: &[c_int],
        timing: &mut DemuxPacketCacheReadTiming,
        trim_allowed: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn next_packet_id_for_stream(
        &self,
        stream_index: c_int,
    ) -> Option<PacketId> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_reader_head_timeline(
        &self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn realign_stream_reader_to_timeline(
        &mut self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn consumer_readable_packet_available(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn consumer_drainable_packet_available(
        &self,
    ) -> bool {
        self.reader_heads.iter().any(|(stream_index, packet_id)| {
            self.reader_head_current_for_stream(*stream_index, *packet_id)
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn consumer_drainable_for_recovery_demand(
        &self,
        video_required: bool,
        audio_required: bool,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn recovery_demand_streams(
        &self,
        video_required: bool,
        audio_required: bool,
    ) -> Vec<c_int> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn drainable_streams(
        &self,
    ) -> Vec<c_int> {
        self.reader_heads
            .iter()
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn consume_packet_id(
        &mut self,
        packet_id: PacketId,
        timing: &mut DemuxPacketCacheReadTiming,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn reset_reader_heads_for_read_index(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_reader_tracking(
        &mut self,
    ) {
        #[cfg(test)]
        {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_read_index_from_reader_head_positions(
        &mut self,
    ) {
        self.read_index = self
            .reader_head_positions
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_queue_snapshot(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_readable_in_current_generation(
        &self,
        packet_id: PacketId,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_blocked_for_current_generation(
        &self,
        packet_id: PacketId,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_reader_head_for_current_generation(
        &mut self,
        stream_index: c_int,
        packet_id: PacketId,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_reader_heads_for_current_generation(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn remove_reader_head(
        &mut self,
        stream_index: c_int,
    ) {
