...
impl DemuxPacketCache {
    #[allow(dead_code)]
    pub(in crate::backend::ffmpeg::playback_loop) fn poll_packet(
        &self,
        stream_index: c_int,
    ) -> DemuxReadResult {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_packet_round_robin(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn poll_packet_round_robin(
        &self,
        stream_indices: &[c_int],
    ) -> (DemuxReadResult, Option<usize>) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn poll_packet_round_robin_with_timing(
        &self,
        stream_indices: &[c_int],
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_available_packet_round_robin_with_lock_wait(
        &self,
        stream_indices: &[c_int],
        lock_wait: Duration,
    ) -> (DemuxReadResult, Option<usize>) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_available_packet_round_robin_with_cache_pause_signal(
        &self,
        stream_indices: &[c_int],
        lock_wait: Duration,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn read_available_packet_round_robin_with_cache_pause_signal_and_timing(
        &self,
        stream_indices: &[c_int],
        lock_wait: Duration,
        cache_pause_signal: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn packet_queue_snapshot(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn repair_reader_heads_for_read_index(
        &self,
        reason: &'static str,
    ) -> bool {
        let mut guard = self
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn try_stream_reader_head_timeline(
        &self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn realign_stream_reader_to_timeline(
        &self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn cached_reader_watermark(
        &self,
    ) -> DemuxReaderWatermark {
        self.shared.cached_monitor_snapshot().reader_watermark
    }

    pub(in crate::backend::ffmpeg::playback_loop) fn monitor_snapshot(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop) fn wait_for_consumer_drainable(
        &self,
        stream_indices: &[c_int],
        timeout: Duration,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop) fn wait_for_cache_generation_change(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn demux_read_blocked_for(
        &self,
    ) -> Option<Duration> {
        self.shared.demux_read_blocked_for()
    }

    pub(in crate::backend::ffmpeg::playback_loop) fn clear_cache_pause_for_decoded_resume(&self) {
        self.shared.clear_cache_pause_for_decoded_resume();
    }

    pub(in crate::backend::ffmpeg::playback_loop) fn set_selected_streams(
        &self,
