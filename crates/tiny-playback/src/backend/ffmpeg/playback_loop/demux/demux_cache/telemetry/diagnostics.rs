...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn demux_cache_blocked_on(
...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn log_demux_packet_append_timing(
    ...
    tracing::trace!(
        ...
        trim_requested = outcome.trim_requested,
        trim_deferred_for_consumer = outcome.trim_deferred_for_consumer,
        trim_deferred_for_recovery = outcome.trim_deferred_for_recovery,
        trim_performed = outcome.trim_outcome.performed,
        trim_steps = outcome.trim_outcome.steps,
        trim_removed_packets = outcome.trim_outcome.removed_packets,
        trim_removed_bytes = outcome.trim_outcome.removed_bytes,
        trim_compacted_global_entries = outcome.trim_outcome.compacted_global_entries,
        trim_global_order_len_before = outcome.trim_outcome.global_order_len_before,
        trim_global_order_len_after = outcome.trim_outcome.global_order_len_after,
        trim_budget_exhausted = outcome.trim_outcome.budget_exhausted,
        trim_remaining_overrun_bytes = outcome.trim_outcome.remaining_overrun_bytes,
        cache_pause_changed,
...
impl DemuxPacketCacheState {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn log_would_block_diagnostic(
        &self,
