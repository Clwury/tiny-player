...
impl DemuxPacketCacheShared {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn prepare_storage_work_for_test(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn start_storage_worker(
        self: &Arc<Self>,
    ) -> Result<(), String> {
