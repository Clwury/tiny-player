...
impl DemuxPacketCacheShared {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_skip_seek_request(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_discard_demux_seek_result(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_discard_demux_read_result(
        &self,
        demux_input_generation: u64,
    ) -> bool {
        self.demux_input_generation() != demux_input_generation
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_stop(&self) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn wait_for_demux_permit(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn demux_input_generation(
        &self,
    ) -> u64 {
        self.state
            .lock()
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn session_id(
        &self,
    ) -> PlaybackSessionId {
        self.state
            .lock()
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn selected_streams(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn consumer_priority_active(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn playback_recovery_critical(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_playback_recovery_demand(
        &self,
        critical: bool,
        video_required: bool,
        audio_required: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn note_consumer_lock_wait(
        &self,
        waited: Duration,
    ) {
