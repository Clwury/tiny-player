...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct StreamResumePosition {
    dts: Option<i64>,
    pos: Option<i64>,
    correct_dts: bool,
    correct_pos: bool,
...
impl StreamResumePosition {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn observe(
        &mut self,
        packet: &CachedDemuxPacket,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn resumable(self) -> bool {
        self.correct_dts || self.correct_pos
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn compare(
        self,
        packet: &CachedDemuxPacket,
    ) -> Option<Ordering> {
        let dts = self
