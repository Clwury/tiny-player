...
impl DemuxPacketCacheState {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_stream_kind(
        &mut self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_requires_recovery_point(
        &self,
        stream_index: c_int,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn recovery_point_stream_index(
        &self,
    ) -> Option<c_int> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn apply_cache_config(
        &mut self,
        cache_config: PlaybackCacheConfig,
    ) {
        let cache_config = cache_config.normalized();
