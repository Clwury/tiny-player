...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct PreparedCacheStateEmit {
...
impl PreparedCacheStateEmit {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn into_emit(
        self,
    ) -> CacheStateEmit {
...
impl DemuxPacketCacheShared {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn send_cache_state_events(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn send_cache_state_emit(
        &self,
        emit: CacheStateEmit,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn prepare_cache_state_emit(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn prepare_cache_state_emit_for(
        &self,
        guard: &mut DemuxPacketCacheState,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn prepare_cache_state_emit_after_append_with_timing(
        &self,
        force: bool,
        appended: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn emit_cache_state_after_read(
        &self,
        guard: &mut DemuxPacketCacheState,
        force: bool,
    ) {
