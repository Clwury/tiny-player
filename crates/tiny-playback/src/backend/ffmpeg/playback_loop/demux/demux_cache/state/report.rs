...
impl DemuxPacketCacheState {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cached_timeline_range(
        &self,
    ) -> Option<(u64, u64)> {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn playback_cache_state(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_report_snapshot(
        &self,
        paused_for_cache: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_report_snapshot_from_prepared(
        &self,
        paused_for_cache: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn take_buffered_changed_for_cache_end(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_state_report_due(
        &self,
        now: Instant,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn mark_cache_state_emit_dirty(
        &mut self,
    ) {
        self.cache_state_emit_dirty = true;
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_state_emit_dirty(
        &self,
    ) -> bool {
        self.cache_state_emit_dirty
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn clear_cache_state_emit_dirty(
        &mut self,
    ) {
        self.cache_state_emit_dirty = false;
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_cache_state_emit(
        &mut self,
        now: Instant,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_emitted_cache_state(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_emitted_seekable_ranges(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_emitted_seekable_ranges_at_revision(
        &mut self,
        seekable_ranges: Vec<PlaybackCacheTimeRange>,
        revision: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn bump_seekability_revision(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seekability_revision(
        &self,
    ) -> u64 {
        self.seekability_revision
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seekable_ranges_changed_since_last_emit(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn normalized_seekable_ranges_changed(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn demux_cache_state_changed(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_emitted_demux_cache_state(
        &mut self,
        state: DemuxCacheState,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn forward_bytes(&self) -> usize {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn reader_forward_bytes(
        &self,
    ) -> usize {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn effective_readahead_nsecs(
        &self,
    ) -> u64 {
        self.readahead_nsecs
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn effective_hysteresis_nsecs(
        &self,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn effective_cache_pause_wait_nsecs(
        &self,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn range_has_current_generation_blocked_packet(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn has_demux_underrun(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn selected_forward_timeline_window(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_window_idle(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_window_underrun(
        &self,
        window: StreamForwardWindow,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_window_needs_reader_packet(
        &self,
        window: StreamForwardWindow,
    ) -> bool {
        !self.effective_eof()
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn active_stream_forward_windows(
        &self,
    ) -> Vec<StreamForwardWindow> {
        self.stream_forward_windows(true)
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn reader_stream_forward_windows(
        &self,
    ) -> Vec<StreamForwardWindow> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seekable_summary_preparation_due(
        &self,
        now: Instant,
    ) -> bool {
        let next_generation = self.generation.saturating_add(1);
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn range_seekable_timeline_summary(
        &self,
        range: &DemuxCachedRange,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_range_stream_seek_boundary(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_range_stream_seek_boundary_after_append(
        &mut self,
        range_id: super::RangeId,
        stream_index: c_int,
        packet_id: PacketId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_range_stream_seek_boundary_in_range(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_range_stream_seek_boundary_after_prefix_prune(
        &self,
        range: &mut DemuxCachedRange,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_range_seek_boundaries(
        &mut self,
        range_id: super::RangeId,
    ) {
        let Some(range) = self.ranges.get(&range_id) else {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn log_seekable_range_diagnostics(
        &self,
