...
impl DemuxPacketCacheState {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn append_packet_fast(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn complete_append_packet_trim(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn raw_input_rate(
        &self,
    ) -> Option<u64> {
        let now = Instant::now();
