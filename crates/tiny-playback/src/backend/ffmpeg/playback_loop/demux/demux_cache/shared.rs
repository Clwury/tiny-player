...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) use super::{
    ...
    DEMUX_WOULD_BLOCK_DIAG_INTERVAL, DemuxCacheReportSnapshot, DemuxPacketAppendTiming,
...
impl DemuxPacketCacheShared {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn notify_ready(&self) {
        self.control.wake();
        self.ready.notify_all();
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn wait_for_ready_change<'a>(
        &'a self,
