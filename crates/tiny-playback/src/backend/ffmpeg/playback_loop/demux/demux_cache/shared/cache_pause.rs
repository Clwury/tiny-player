...
impl DemuxPacketCacheShared {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn enter_initial_cache_pause_if_needed(
        &self,
    ) {
        let emit = {
            let mut guard = self
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn enter_cache_pause_if_needed(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn enter_cache_pause(
        &self,
        guard: &mut DemuxPacketCacheState,
    ) -> CachePauseRefresh {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_cache_pause(
        &self,
        guard: &mut DemuxPacketCacheState,
    ) -> CachePauseRefresh {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn refresh_cache_pause_after_append(
        &self,
        guard: &mut DemuxPacketCacheState,
    ) -> CachePauseRefresh {
