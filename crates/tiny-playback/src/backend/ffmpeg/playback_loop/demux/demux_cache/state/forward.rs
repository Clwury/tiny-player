...
impl DemuxPacketCacheState {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn range_forward_stats<'a>(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn update_range_forward_stats_after_append(
        &self,
        packet_id: PacketId,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn active_packet_is_forward(
        &self,
        packet_id: PacketId,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn clear_reader_tracking(&mut self) {
        self.read_index = 0;
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn rebuild_forward_cache(&mut self) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn update_forward_cache_after_appended_packet(
        &mut self,
        packet_id: PacketId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn update_forward_cache_after_consumed_packet(
        &mut self,
        packet_id: PacketId,
    ) {
        let Some(packet) = self.packets.get(&packet_id) else {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn update_forward_cache_after_reader_realign(
        &mut self,
        stream_index: c_int,
