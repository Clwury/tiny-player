...
impl DemuxPacketCacheState {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_cached(
        &mut self,
        target_nsecs: u64,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_cached_fast(
        &mut self,
        target_nsecs: u64,
        session_id: PlaybackSessionId,
    ) -> Option<f64> {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_cached_with_generation(
        &mut self,
        target_nsecs: u64,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_cached_with_generation_hit(
        &mut self,
        target_nsecs: u64,
        mode: PlaybackSeekMode,
        session_id: PlaybackSessionId,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_cached_with_generation_attempt(
        &mut self,
        target_nsecs: u64,
        mode: PlaybackSeekMode,
        session_id: PlaybackSessionId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn resolve_cached_seek_plan_attempt(
        &self,
        target_nsecs: u64,
        mode: PlaybackSeekMode,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn record_cached_seek_rejection(
        &mut self,
        miss: CachedSeekMiss,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn commit_cached_seek_plan(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn exclude_failed_cached_seek_range(
        &mut self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn failed_cached_seek_range(
        &self,
        range_id: RangeId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn activate_range_for_read(
        &mut self,
        range_id: RangeId,
        read_index: usize,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn request_seek(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn request_continuation_seek(
        &mut self,
        seek_generation: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn take_seek_request(
        &mut self,
