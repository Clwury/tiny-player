...
use crate::backend::ffmpeg::codec::NalPacketFormat;
use ffmpeg_sys_next as ffi;

use crate::backend::ffmpeg::playback_loop::subtitle_cue_timeline_nsecs;
...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct DemuxPacketTimeline {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) buffered_reporter: BufferedReporter,
...
impl DemuxPacketTimeline {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_packet_format(
        &self,
        packet: &mut AvPacket,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_selected_streams(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn reset(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cache_packet(
        &mut self,
        packet: &AvPacket,
        event_tx: &Sender<BackendEvent>,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn should_cache_stream(
        &self,
        stream_index: c_int,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn buffered_until(
        &self,
    ) -> Option<f64> {
        self.buffered_reporter.buffered_until()
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_session_id(
        &mut self,
        session_id: PlaybackSessionId,
    ) {
        self.session_id = session_id;
