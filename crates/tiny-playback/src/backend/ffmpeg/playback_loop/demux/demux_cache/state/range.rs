...
impl DemuxPacketCacheState {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn range_can_resume(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn next_range_id(
        &mut self,
    ) -> RangeId {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_range(
        &self,
    ) -> &DemuxCachedRange {
        self.ranges
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_range_mut(
        &mut self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn append_range(
        &self,
    ) -> &DemuxCachedRange {
        self.ranges
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn append_range_mut(
        &mut self,
    ) -> &mut DemuxCachedRange {
        self.ranges
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_range_eof(&self) -> bool {
        self.read_range().is_eof
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_range_eager_streams_exhausted(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn current_generation_range_view(
        &self,
        range: &DemuxCachedRange,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn next_generation_range_view(
        &self,
        range: &DemuxCachedRange,
    ) -> (VecDeque<u64>, BTreeMap<c_int, VecDeque<u64>>) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn detached_append_range_id(
        &self,
    ) -> Option<RangeId> {
        (self.append_range_id != self.read_range_id).then_some(self.append_range_id)
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn detached_append_range(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn start_new_current_range(
        &mut self,
        is_bof: bool,
    ) {
        let range_id = self.next_range_id();
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn start_detached_append_range(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn enforce_cached_range_limit(
        &mut self,
    ) -> usize {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn preserve_current_range(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn preserve_detached_append_range(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn activate_detached_append_range(
        &mut self,
    ) -> bool {
        let Some(range_id) = self.detached_append_range_id() else {
            return false;
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn remove_range_packets(
        &mut self,
        range: DemuxCachedRange,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn discard_ranges_before_track_refresh(
        &mut self,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn mark_read_stream_bof(
        &mut self,
        stream_index: c_int,
        is_bof: bool,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_range_eof(
        &mut self,
        range_id: RangeId,
        is_eof: bool,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn archived_bytes(&self) -> usize {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_read_index_for_test(
        &mut self,
        read_index: usize,
    ) {
