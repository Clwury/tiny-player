...
impl DemuxPacketCache {
    pub(in crate::backend::ffmpeg::playback_loop) fn set_playback_recovery_demand(
        &self,
        critical: bool,
        video_required: bool,
        audio_required: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn seek(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn seek_cached_only(
        &self,
        position_seconds: f64,
        mode: PlaybackSeekMode,
        session_id: PlaybackSessionId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn seek_cached_safe_only(
        &self,
        position_seconds: f64,
        mode: PlaybackSeekMode,
        session_id: PlaybackSessionId,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn seek_low_level(
        &self,
        position_seconds: f64,
        session_id: PlaybackSessionId,
        seek_generation: u64,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn exclude_failed_cached_seek_range(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn shutdown(&self) {
        let mut guard = self
            .shared
            .state
            .lock()
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn apply_cache_config(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop) fn wait_until_initial_cache_fill(
        &self,
