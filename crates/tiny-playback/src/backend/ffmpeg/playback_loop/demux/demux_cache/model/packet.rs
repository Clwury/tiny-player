...
use crate::backend::ffmpeg::disk_cache::DiskBlock;
...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct CachedDemuxPacket {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) payload: CachedDemuxPacketPayload,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) stream_index: c_int,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) timeline_anchor: bool,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) demux_keyframe: bool,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) recovery_point: bool,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) recovery_kind:
        VideoRecoveryPointKind,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) safe_seek_point: bool,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) raw_pos: Option<i64>,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) start_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) end_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) byte_len: usize,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) properties_byte_len: usize,
}

#[derive(Clone, Copy)]
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct CachedDemuxPacketRecovery {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) recovery_point: bool,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) recovery_kind:
        VideoRecoveryPointKind,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) safe_seek_point: bool,
...
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) enum CachedDemuxPacketPayload {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct PreparedDemuxPacketDiskSpill {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) data: Vec<u8>,
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) props: AvPacket,
}

pub(in crate::backend::ffmpeg::playback_loop::demux_cache) struct DemuxPacketReadSource {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) stream_offset: usize,
...
impl DemuxPacketReadSource {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_ref(
        self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn set_diagnostic(
        &mut self,
...
impl CachedDemuxPacket {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn is_cached_seek_anchor(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn cached_seek_anchor_kind(
        &self,
    ) -> VideoRecoveryPointKind {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn prepare_disk_spill(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn finish_disk_spill(
        &mut self,
        block: Arc<DiskBlock>,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn memory_packet(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn resident_bytes(&self) -> usize {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn disk_bytes(&self) -> usize {
        match &self.payload {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_end_nsecs(
        &self,
    ) -> Option<u64> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn seek_block_timestamp_nsecs(
        &self,
    ) -> Option<u64> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn from_packet(
        packet: &AvPacket,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_source(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn restore_outside_disk_limit(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn storage_kind(
        &self,
    ) -> AvPacketStorageKind {
        match &self.payload {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn spill_to_disk(
        &mut self,
