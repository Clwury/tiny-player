...
impl DemuxPacketCacheState {
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn trim_after_read_needed(
        &self,
    ) -> bool {
        self.backbuffer_pressure()
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn memory_pressure(&self) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn backbuffer_pressure(
        &self,
    ) -> bool {
        self.backward_bytes() > self.effective_backbuffer_limit()
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn backbuffer_trim_urgent(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn append_trim_due(
        &mut self,
        force: bool,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn complete_append_trim(&mut self) {
        self.append_trim_pending = false;
        self.append_trim_pressure_packets = 0;
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn read_trim_due(&mut self) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_packet_queue_limit(
        &self,
        stream_index: c_int,
    ) -> usize {
        match self
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn stream_packet_queue_full(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn trim_to_limit(&mut self) -> bool {
        self.trim_to_limit_with_budget(None, None).performed
    }

    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn trim_to_limit_for_append(
        &mut self,
    ) -> bool {
        self.trim_to_limit_for_append_with_outcome().performed
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn trim_to_limit_for_append_with_outcome(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn trim_to_limit_for_read_with_outcome(
        &mut self,
    ) -> DemuxPacketTrimOutcome {
        self.trim_to_limit_with_budget(
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn remove_read_range_stream_prefix_packets_for_test(
        &mut self,
        stream_index: c_int,
        count: usize,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_is_stream_seek_boundary(
        &self,
        stream_index: c_int,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn packet_is_stream_seek_boundary_for(
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn rebuild_range_stream_seek_boundaries(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn discard_stream_packets(
        &mut self,
        stream_index: c_int,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn backward_bytes(&self) -> usize {
        self.cached_bytes.saturating_sub(self.forward_bytes())
    }

    pub(in crate::backend::ffmpeg::playback_loop::demux_cache) fn effective_backbuffer_limit(
        &self,
    ) -> usize {
