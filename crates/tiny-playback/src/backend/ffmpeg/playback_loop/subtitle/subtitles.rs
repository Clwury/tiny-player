...
impl SubtitlePipeline {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop) fn empty_for_test() -> Self {
        Self {
            stream: None,
            worker: None,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop) fn with_worker_for_test(
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::playback_loop) fn with_external_cues_for_test(
