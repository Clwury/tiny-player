...
use crate::{backend::BackendEvent, render_host::VideoOutputQueue};
...
pub(in crate::backend::ffmpeg) const VIDEO_MINIMUM_PRESENT_INTERVAL: Duration =
...
pub(in crate::backend::ffmpeg) struct VideoDeadlineService {
...
impl VideoDeadlineService {
    ...
    pub(in crate::backend::ffmpeg) fn spawn(
        queue: ScheduledVideoDeadlineQueue,
    ...
    pub(in crate::backend::ffmpeg) fn update_audio_clock(
        &self,
        audio_clock: Option<AudioClockHandle>,
    ) {
        *self
