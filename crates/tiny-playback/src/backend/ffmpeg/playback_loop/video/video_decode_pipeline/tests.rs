...
fn packet_from_data(data: &[u8]) -> crate::backend::ffmpeg::AvPacket {
    let props = crate::backend::ffmpeg::AvPacket::new().expect("packet props allocate");
    crate::backend::ffmpeg::AvPacket::from_data_and_props(data, &props)
