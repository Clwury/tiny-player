...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct HevcLowLevelSeekLanding {
...
pub(super) struct VideoPacketAdmissionContext<'a> {
    ...
    pub(super) presentation: Option<crate::render_host::VideoPresentation>,
}
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum VideoDecodeRecoveryScope {
    #[default]
    SafeBoundary,
    ExactCachedSeek {
        transaction_id: u64,
...
impl VideoDecodeRecoveryScope {
    ...
    pub(in crate::backend::ffmpeg) fn transaction_id(self) -> Option<u64> {
        match self {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct ExactSeekPacketProgress {
    pub(in crate::backend::ffmpeg) transaction_id: u64,
    pub(in crate::backend::ffmpeg) recovery_scope: VideoDecodeRecoveryScope,
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) packet_nsecs: u64,
    pub(in crate::backend::ffmpeg) packet_count: u64,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct ExactSeekCompletion {
    pub(in crate::backend::ffmpeg) transaction_id: u64,
    pub(in crate::backend::ffmpeg) recovery_scope: VideoDecodeRecoveryScope,
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) first_eligible_frame_nsecs: u64,
    pub(in crate::backend::ffmpeg) first_eligible_delta_nsecs: u64,
}

#[derive(Default)]
pub(in crate::backend::ffmpeg) struct VideoDecodeRecovery {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct SeekPrerollFrameProgress {
    pub(in crate::backend::ffmpeg) timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) preroll_frames: u64,
    pub(in crate::backend::ffmpeg) first_preroll_frame_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) last_preroll_frame_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) recovery_scope: VideoDecodeRecoveryScope,
}

impl VideoDecodeRecovery {
    pub(in crate::backend::ffmpeg) fn reset(&mut self) {
    ...
    pub(in crate::backend::ffmpeg) fn reset_for_timeline_start(
        &mut self,
        codec_id: ffi::AVCodecID,
    ...
    pub(in crate::backend::ffmpeg) fn begin_verified_replay_from_safe_anchor(
        &mut self,
        codec_id: ffi::AVCodecID,
        target_nsecs: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg) fn waiting_for_keyframe(&self) -> bool {
        self.waiting_for_keyframe
    }

    pub(in crate::backend::ffmpeg) fn enable_hevc_cached_recovery_point(
        &mut self,
        transaction_id: u64,
        target_nsecs: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg) fn enable_hevc_low_level_recovery_point(
        &mut self,
        landing: HevcLowLevelSeekLanding,
    ) {
        if self.waiting_for_keyframe {
    ...
    pub(in crate::backend::ffmpeg) fn recovery_scope(&self) -> VideoDecodeRecoveryScope {
        self.recovery_scope
    }

    pub(in crate::backend::ffmpeg) fn requires_exact_seek_output(&self) -> bool {
        self.verified_replay_target_nsecs.is_some()
            || !matches!(self.recovery_scope, VideoDecodeRecoveryScope::SafeBoundary)
    }

    pub(in crate::backend::ffmpeg) fn verified_replay_target_nsecs(&self) -> Option<u64> {
        self.verified_replay_target_nsecs
    }

    pub(in crate::backend::ffmpeg) fn frame_start_position_nsecs(
        &self,
        current_start_position_nsecs: u64,
    ) -> u64 {
        self.verified_replay_target_nsecs
    ...
    pub(in crate::backend::ffmpeg) fn should_skip_nonref_for_seek_preroll(
        &mut self,
        packet_nsecs: Option<u64>,
    ...
    pub(in crate::backend::ffmpeg) fn skipped_packets(&self) -> u64 {
        self.skipped_packets
    }

    pub(in crate::backend::ffmpeg) fn should_skip_packet(
        &self,
        packet: &AvPacket,
        codec_id: ffi::AVCodecID,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn record_skipped_packet(
        &mut self,
        packet_nsecs: Option<u64>,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg) fn skipped_packet_span_nsecs(&self) -> Option<u64> {
        self.first_skipped_packet_nsecs
            .zip(self.last_skipped_packet_nsecs)
            .map(|(first, last)| last.saturating_sub(first))
    }

    pub(in crate::backend::ffmpeg) fn observe_exact_seek_packet_progress(
        &mut self,
        packet_nsecs: Option<u64>,
    ...
    pub(in crate::backend::ffmpeg) fn seek_bootstrap_preroll_frames(&self) -> u64 {
        self.seek_bootstrap_preroll_frames
    }

    pub(in crate::backend::ffmpeg) fn observe_seek_preroll_frame(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn finish_seek_bootstrap_after_target_frame(
        &mut self,
        frame_timeline_nsecs: u64,
    ) -> Option<SeekPrerollFrameProgress> {
        let target_nsecs = self.seek_bootstrap_target_nsecs?;
    ...
    pub(in crate::backend::ffmpeg) fn take_exact_seek_completion(
        &mut self,
    ) -> Option<ExactSeekCompletion> {
        self.completed_exact_seek.take()
    }

    pub(in crate::backend::ffmpeg) fn accept_recovery_point(
        &mut self,
        packet: &AvPacket,
        codec_id: ffi::AVCodecID,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn accept_hevc_recovery_point_after_wait_limit(
        &mut self,
        packet: &AvPacket,
        codec_id: ffi::AVCodecID,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn accept_after_wait_limit(
        &mut self,
        codec_id: ffi::AVCodecID,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn take_realign_on_next_frame(&mut self) -> bool {
        let realign = self.realign_on_next_frame;
        self.realign_on_next_frame = false;
        realign
    }

    pub(in crate::backend::ffmpeg) fn begin_with_realign(
        &mut self,
        realign_after_recovery_point: bool,
    ) {
...
pub(in crate::backend::ffmpeg) fn video_decode_error_is_recoverable(error: &str) -> bool {
