...
fn wait_after_missing_recovery_request(
    ...
    session_id: crate::render_host::PlaybackSessionId,
...
pub(in crate::backend::ffmpeg) fn run_ffmpeg_playback(
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn playback_read_finished(
    read_result: c_int,
...
mod tests {
    ...
    use crate::backend::ffmpeg::AudioOutputSnapshot;
    use crate::backend::ffmpeg::playback_loop::PlaybackOutputState;
