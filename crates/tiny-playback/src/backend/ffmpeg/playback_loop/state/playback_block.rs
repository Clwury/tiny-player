...
pub(in crate::backend::ffmpeg) struct VideoOutputResourcePressure {
    pub(in crate::backend::ffmpeg) scheduled_video_frames: usize,
    pub(in crate::backend::ffmpeg) decoded_video_frames: usize,
    pub(in crate::backend::ffmpeg) submitted_not_consumed_video_packets: usize,
    pub(in crate::backend::ffmpeg) prepare_worker_frames: usize,
    pub(in crate::backend::ffmpeg) recovery_staging_frames: usize,
    pub(in crate::backend::ffmpeg) hardware_accelerated: bool,
    pub(in crate::backend::ffmpeg) scheduled_video_queue_limit_reached: bool,
    pub(in crate::backend::ffmpeg) decode_recovery_video_admission_blocked: bool,
    pub(in crate::backend::ffmpeg) fill_phase_for_output_start: bool,
    pub(in crate::backend::ffmpeg) video_frame_duration_nsecs: u64,
    pub(in crate::backend::ffmpeg) vo_queue_capacity: usize,
    pub(in crate::backend::ffmpeg) vo_queued_frames: usize,
    ...
    pub(in crate::backend::ffmpeg) render_backlogged: bool,
}

impl VideoOutputResourcePressure {
    pub(in crate::backend::ffmpeg) fn active_frames(self) -> usize {
    ...
    pub(in crate::backend::ffmpeg) fn dynamic_frame_budget(self) -> usize {
    ...
    pub(in crate::backend::ffmpeg) fn hard_frame_budget(self) -> usize {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum PlaybackBlockReason {
    DemuxCache,
    PacketQueueFull,
    DecoderRecovery,
    DecoderInFlight,
...
pub(in crate::backend::ffmpeg) fn video_output_resource_pressure(
...
pub(in crate::backend::ffmpeg) fn video_decode_block_reason_with_output_queue(
