...
use crate::backend::{BackendDiagnostic, BackendEventKind};

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialAudioNoPayloadDisposition {
    RetryTransient,
    RebufferTerminal,
}

pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn initial_audio_no_payload_disposition(
    would_block: bool,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) struct InitialAudioAmmunitionSnapshot {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) audio_start_target_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) pending_audio_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) pending_audio_range_nsecs:
        Option<(u64, u64)>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) pending_audio_contiguous_range_nsecs:
        Option<(u64, u64)>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) pending_audio_buffered_until_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) device_audio_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) device_audio_range_nsecs:
        Option<(u64, u64)>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) device_audio_buffered_until_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) decoded_audio_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) decoded_audio_ledger_observed: bool,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) decoded_audio_estimated_range_nsecs:
        Option<(u64, u64)>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) total_audio_nsecs: u64,
}

impl InitialAudioAmmunitionSnapshot {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn from_ledgers(
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn from_optional_ledgers(
        output_scheduler: &PlaybackOutputScheduler,
        audio_snapshot: Option<AudioOutputSnapshot>,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn pending_covers_target(
        self,
    ) -> bool {
        self.pending_audio_buffered_until_nsecs.is_some()
    }

    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn device_covers_target(
        self,
    ) -> bool {
        self.device_audio_buffered_until_nsecs.is_some()
    }

    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn covers_target(self) -> bool {
        self.pending_covers_target() || self.device_covers_target()
    }

    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn reaches_force_start_threshold(
        self,
    ) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialAudioStartAction {
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn initial_audio_start_action(
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn initial_audio_start_ammunition_ready(
    output_scheduler: &PlaybackOutputScheduler,
    audio_snapshot: Option<AudioOutputSnapshot>,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn initial_audio_clock_reset_required(
    ammunition: InitialAudioAmmunitionSnapshot,
) -> bool {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn release_initial_seek_transition_after_clock_reset(
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn commit_initial_av_start(
    output_scheduler: &mut PlaybackOutputScheduler,
    control: &FfmpegControl,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialAudioCommitCheckpoint {
    SchedulerCommitted,
    ControlCommitted,
    StreamPlayed,
}
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn commit_initial_audio_stage_with_checkpoints_for_test(
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn abort_initial_audio_stage_for_test(
    scheduler: &mut PlaybackOutputScheduler,
    output: &AudioOutput,
    token: InitialAudioPrepareToken,
    session_id: PlaybackSessionId,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn fail_initial_av_start_after_unstable_snapshot_deadline(
    output_scheduler: &mut PlaybackOutputScheduler,
    output: &AudioOutput,
...
pub(in crate::backend::ffmpeg) fn expire_initial_av_start_hard_deadline(
    output_scheduler: &mut PlaybackOutputScheduler,
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn abort_initial_av_start_for_discontinuity_change(
    output_scheduler: &mut PlaybackOutputScheduler,
    output: &AudioOutput,
    transaction: super::InitialAvStartTransaction,
    control: &FfmpegControl,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg::playback_loop) fn service_initial_video_clock_until_audio_start(
    output_scheduler: &mut PlaybackOutputScheduler,
    output: &AudioOutput,
