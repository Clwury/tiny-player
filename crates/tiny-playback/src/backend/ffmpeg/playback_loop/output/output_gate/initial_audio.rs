...
pub(in crate::backend::ffmpeg::playback_loop) enum InitialAudioPreparePhase {
    #[default]
    Collecting,
    Preparing,
    Prepared,
...
impl InitialAudioPreparePhase {
    pub(in crate::backend::ffmpeg::playback_loop) fn as_str(self) -> &'static str {
        match self {
...
pub(in crate::backend::ffmpeg::playback_loop) struct InitialAudioPrepareToken {
    pub(in crate::backend::ffmpeg::playback_loop) transaction_id: u64,
    pub(in crate::backend::ffmpeg::playback_loop) discontinuity_epoch: u64,
    pub(in crate::backend::ffmpeg::playback_loop) seek_generation: u64,
    pub(in crate::backend::ffmpeg::playback_loop) audio_epoch: u64,
    pub(in crate::backend::ffmpeg::playback_loop) target_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop) staged_range_nsecs: (u64, u64),
    pub(in crate::backend::ffmpeg::playback_loop) staged_frames: usize,
    pub(in crate::backend::ffmpeg::playback_loop) staged_samples: usize,
    pub(in crate::backend::ffmpeg::playback_loop) staged_until_nsecs: u64,
}

impl InitialAudioPrepareToken {
    pub(in crate::backend::ffmpeg::playback_loop) fn covers_target(self) -> bool {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop) struct PrestartAudioOwnershipInput {
    pub(in crate::backend::ffmpeg::playback_loop) phase: InitialAudioPreparePhase,
    pub(in crate::backend::ffmpeg::playback_loop) token: Option<InitialAudioPrepareToken>,
    pub(in crate::backend::ffmpeg::playback_loop) current_audio_epoch: u64,
    pub(in crate::backend::ffmpeg::playback_loop) current_seek_generation: u64,
    pub(in crate::backend::ffmpeg::playback_loop) target_nsecs: u64,
    pub(in crate::backend::ffmpeg::playback_loop) snapshot: AudioOutputStableSnapshot,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop) enum PrestartAudioOwnership {
    CollectingEmpty,
...
pub(in crate::backend::ffmpeg::playback_loop) fn classify_prestart_audio_ownership(
