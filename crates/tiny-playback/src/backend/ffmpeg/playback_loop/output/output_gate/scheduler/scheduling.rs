...
impl PlaybackOutputScheduler {
    pub(in crate::backend::ffmpeg) fn scheduled_video_queue_limit_reached(
        &self,
    ...
    pub(in crate::backend::ffmpeg) fn scheduled_video_queue_len(&self) -> usize {
    ...
    pub(in crate::backend::ffmpeg) fn video_decode_skip_nonref_for_pressure(
        &self,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn startup_sync_elapsed(
        &self,
    ) -> Option<Duration> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn rebuffer_wait_elapsed(
        &self,
    ) -> Option<Duration> {
        self.playback_output_state
            .rebuffering()
    ...
    pub(in crate::backend::ffmpeg) fn rebuffer_empty_audio_output_watchdog_delay(
        &self,
    ) -> Option<Duration> {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn mark_startup_first_frame_stall_logged(
        &mut self,
    ) -> bool {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn push_decoded_video_for_test(
        &mut self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn push_pending_start_audio_for_test(
        &mut self,
        audio: DecodedAudio,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn set_video_output_underrun_started_at_for_test(
        &mut self,
        started_at: Instant,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn expire_audio_reader_gap_watchdog_for_test(&mut self) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn video_output_underrun_started_for_test(&self) -> bool {
        self.video_output_underrun_started_at.is_some()
    }

    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn set_video_output_rebuffer_anchor_for_test(
        &mut self,
