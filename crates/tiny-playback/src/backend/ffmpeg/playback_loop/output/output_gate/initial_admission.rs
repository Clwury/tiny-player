...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) struct InitialAvPair {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialStartAdmissionMode {
    FastLookahead,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialStartBlockReason {
    NoVideoFrame,
    NoAudioFrame,
    NoAudioCoverage,
    AudioVideoOffset,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum InitialStartAdmission {
...
impl InitialStartAdmission {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn blocked_on(
        self,
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) struct InitialStartAdmissionInput {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) expected_target_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) decoded_video_forward_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) strict_video_forward_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) decoded_audio_forward_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) contiguous_video_frames: usize,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) first_video_duration_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) first_following_video_gap_nsecs:
        Option<u64>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) first_frame_is_vulkan: bool,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) first_frame_confirmed_clean: bool,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) active_recovery: bool,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) require_strict_fast_lookahead: bool,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) cached_exact_landing_nsecs:
        Option<u64>,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) struct InitialStartAdmissionEvaluation {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) pair: Option<InitialAvPair>,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) admission: InitialStartAdmission,
}

pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn initial_start_admission(
