...
impl PlaybackOutputScheduler {
    pub(in crate::backend::ffmpeg) fn begin_decode_recovery(
        &mut self,
        transaction_id: u64,
        target_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg) fn mark_decode_recovery_replaying(
        &mut self,
        transaction_id: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg) fn decode_recovery_phase(&self) -> Option<DecodeRecoveryPhase> {
        self.decode_recovery_transaction
            .as_ref()
            .map(|transaction| transaction.phase)
    }

    pub(in crate::backend::ffmpeg) fn decode_recovery_active(&self) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn decode_recovery_owns_video_admission(&self) -> bool {
    ...
    pub(in crate::backend::ffmpeg) fn committed_video_queue_end_nsecs(&self) -> Option<u64> {
        self.scheduled_video_queue
            .range_nsecs()
            .map(|(_, end_nsecs)| end_nsecs)
    }

    pub(in crate::backend::ffmpeg) fn admitted_video_queue_end_nsecs(&self) -> Option<u64> {
        self.committed_video_queue_end_nsecs()
    }

    pub(in crate::backend::ffmpeg) fn recovery_staged_high_water_nsecs(&self) -> Option<u64> {
        self.recovery_staging_range_nsecs()
            .map(|(_, end_nsecs)| end_nsecs)
    }

    pub(in crate::backend::ffmpeg) fn recovery_staging_range_nsecs(&self) -> Option<(u64, u64)> {
        self.decode_recovery_transaction
            .as_ref()
    ...
    pub(in crate::backend::ffmpeg) fn recovery_staging_frames(&self) -> usize {
        self.decode_recovery_transaction
            .as_ref()
            .filter(|transaction| !transaction.phase.terminal())
    ...
    pub(in crate::backend::ffmpeg) fn recovery_staging_frame_budget(&self) -> Option<usize> {
        self.decode_recovery_transaction
            .as_ref()
            .filter(|transaction| !transaction.phase.terminal())
    ...
    pub(in crate::backend::ffmpeg) fn decode_recovery_video_admission_blocked(&self) -> bool {
        self.decode_recovery_transaction
            .as_ref()
    ...
    pub(in crate::backend::ffmpeg) fn decode_recovery_output_committed(&self) -> bool {
        self.decode_recovery_transaction
            .as_ref()
            .is_some_and(|transaction| {
                matches!(
    ...
    pub(in crate::backend::ffmpeg) fn confirm_decode_recovery_synchronized_timeline_gap(&mut self) {
    ...
    pub(in crate::backend::ffmpeg) fn take_decode_recovery_drop_for_fallback(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn release_vulkan_frames_for_resource_pressure(
        &mut self,
        control: &FfmpegControl,
        session_id: PlaybackSessionId,
    ) -> usize {
    ...
    pub(in crate::backend::ffmpeg) fn update_decode_recovery_audio_ready(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn decode_recovery_audio_ready_latched(&self) -> bool {
        self.decode_recovery_transaction
            .as_ref()
    ...
    pub(in crate::backend::ffmpeg) fn stage_decode_recovery_frame(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn check_decode_recovery_deadline(
        &mut self,
        now: Instant,
        control: &FfmpegControl,
        session_id: PlaybackSessionId,
    ...
    pub(in crate::backend::ffmpeg) fn commit_decode_recovery_if_buffered(
        &mut self,
        control: &FfmpegControl,
    ...
    pub(in crate::backend::ffmpeg) fn maybe_enter_decode_recovery_barrier(
        &mut self,
        now: Instant,
