...
use crate::render_host::FramePixels;

pub(in crate::backend::ffmpeg::playback_loop::output_gate) const MAX_REBUFFER_AUDIO_LEAD_NSECS:
    u64 = 2_000_000_000;

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) enum StaleRebufferPendingAudio {
    Ahead {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum OutputGateResumeStatus {
    Idle,
    Waiting,
    Rebuffering,
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) struct OutputGateResumeTiming {
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) audio_snapshot: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) resume_decision: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) demux_watermark: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) waterline: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fallback: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) resume_action: Duration,
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) wait_log: Duration,
}
...
#[cfg(test)]
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn stale_rebuffer_pending_audio_ahead(
    output_scheduler: &PlaybackOutputScheduler,
    audio_snapshot: AudioOutputSnapshot,
    resume_timeline_nsecs: u64,
) -> Option<u64> {
...
pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn stale_rebuffer_pending_audio(
    output_scheduler: &PlaybackOutputScheduler,
    audio_snapshot: AudioOutputSnapshot,
    resume_timeline_nsecs: u64,
...
pub(in crate::backend::ffmpeg) fn service_output_gate_resume_if_ready<F>(
    output_scheduler: &mut PlaybackOutputScheduler,
