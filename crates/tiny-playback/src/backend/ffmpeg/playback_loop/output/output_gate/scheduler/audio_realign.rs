...
impl PlaybackOutputScheduler {
    pub(in crate::backend::ffmpeg) fn observe_rebuffer_far_ahead_audio_frame(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn request_output_wait_audio_reader_head_realign_if_needed(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn record_audio_continuity_rejection(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn clear_rebuffer_far_ahead_audio_observation(
        &mut self,
        session_id: PlaybackSessionId,
        reason: &'static str,
    ) {
    ...
    pub(in crate::backend::ffmpeg) fn rebuffer_audio_realign_request_pending(&self) -> bool {
        self.rebuffer_audio_realign_request.is_some()
    }

    pub(in crate::backend::ffmpeg) fn take_rebuffer_audio_realign_request(
        &mut self,
    ) -> Option<RebufferAudioRealignRequest> {
    ...
    pub(in crate::backend::ffmpeg) fn defer_audio_reader_gap_watchdog_after_input_pending(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn prepare_audio_after_rebuffer_realign(
        &mut self,
        target_timeline_nsecs: u64,
        session_id: PlaybackSessionId,
        reason: &'static str,
    ...
    pub(in crate::backend::ffmpeg) fn audio_far_ahead_reference_timeline_nsecs(
        &self,
        current_start_position_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn begin_audio_gap_recovery(
        &mut self,
        target_timeline_nsecs: u64,
        now: Instant,
        session_id: PlaybackSessionId,
    ...
    pub(in crate::backend::ffmpeg) fn audio_realign_exhausted_for(
        &self,
        target_timeline_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg) fn resume_after_exhausted_audio_realign(
        &mut self,
        target_timeline_nsecs: u64,
        far_ahead_audio_timeline_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg) fn audio_gap_recovery_active(&self) -> bool {
        self.audio_gap_recovery_until.is_some()
    }

    pub(in crate::backend::ffmpeg) fn clear_audio_gap_recovery_if_audio_ready(
        &mut self,
        audio_snapshot: Option<AudioOutputSnapshot>,
    ...
    pub(in crate::backend::ffmpeg) fn set_rebuffer_empty_audio_output_blocked(
        &mut self,
        blocked: bool,
    ) {
        self.rebuffer_empty_audio_output_blocked =
    ...
    pub(in crate::backend::ffmpeg) fn set_audio_sync_drop_before_timeline_nsecs(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg) fn audio_sync_drop_before_timeline_nsecs(&self) -> Option<u64> {
        self.audio_sync_drop_before_timeline_nsecs
    }

    pub(in crate::backend::ffmpeg) fn record_audio_sync_drop_before_frame(
        &mut self,
        raw_timestamp: i64,
        timeline_nsecs: u64,
    ...
    pub(in crate::backend::ffmpeg) fn clear_audio_sync_drop_before_if_covered(
        &mut self,
        audio_snapshot: Option<AudioOutputSnapshot>,
        session_id: PlaybackSessionId,
        reason: &'static str,
    ...
    pub(in crate::backend::ffmpeg) fn observe_audio_output_underrun_for_rebuffer(
        &mut self,
        now: Instant,
        session_id: PlaybackSessionId,
    ) {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn audio_rebuffer_loop_active(
        &self,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::playback_loop::output_gate) fn audio_rebuffer_prefill_target_nsecs(
        &self,
