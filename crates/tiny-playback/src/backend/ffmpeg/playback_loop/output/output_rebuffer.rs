...
use super::{
    ...
    VIDEO_OUTPUT_START_PREBUFFER_DURATION, duration_nsecs, queued_video_duration,
...
pub(in crate::backend::ffmpeg) enum PlaybackOutputState {
    Syncing,
    Primed,
    Playing,
    Rebuffering,
...
impl PlaybackOutputState {
    pub(in crate::backend::ffmpeg) fn restart_pending(self) -> bool {
        matches!(self, Self::Syncing | Self::Primed)
    }

    pub(in crate::backend::ffmpeg) fn first_video_frame_pending(self) -> bool {
        self.restart_pending()
    }

    pub(in crate::backend::ffmpeg) fn rebuffering(self) -> bool {
        matches!(self, Self::Rebuffering)
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct AudioClockResumeDecision {
    pub(in crate::backend::ffmpeg) timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) reset_audio_to_video: bool,
    pub(in crate::backend::ffmpeg) delayed_audio_start_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) allow_audio_gap_at_video_resume: bool,
    pub(in crate::backend::ffmpeg) resume_anchor_source: ResumeAnchorSource,
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum ResumeAnchorSource {
    #[default]
    Video,
    Audio,
    AudioGapReset,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct InitialOutputSyncDecision {
    pub(in crate::backend::ffmpeg) video_resume_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) audio_start_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) delayed_audio_start_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) drop_audio_before_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) stale_audio_preroll_until_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) stale_audio_preroll_gap_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) allow_initial_audio_gap_at_video_start: bool,
    pub(in crate::backend::ffmpeg) reset_audio_to_video: bool,
}

impl InitialOutputSyncDecision {
    pub(in crate::backend::ffmpeg) fn audio_clock_resume_decision(
        self,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct RebufferResumeAnchor {
    pub(in crate::backend::ffmpeg) timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) reset_to_video_when_decoded_queue_misses_anchor: bool,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum VideoOutputUnderflowClassification {
    DemuxRebuffer,
    DecodeUnderfill,
...
impl VideoOutputUnderflowClassification {
    ...
    pub(in crate::backend::ffmpeg) fn decode_underfill(self) -> bool {
        matches!(self, Self::DecodeUnderfill | Self::StartupDecodeStabilizing)
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct AudioResumeWaterline {
    pub(in crate::backend::ffmpeg) resume_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) audio_accepted_start_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_accepted_start_gap_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) accepted_contiguous_coverage_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_output_buffered_until_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_output_pending_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) pending_audio_start_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) pending_audio_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) decoded_audio_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_decode_queued_nsecs: u64,
    pub(in crate::backend::ffmpeg) audio_decode_in_flight_packets: usize,
    pub(in crate::backend::ffmpeg) demux_audio_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) demux_audio_cached_packets: Option<usize>,
    pub(in crate::backend::ffmpeg) ready: bool,
}

impl AudioResumeWaterline {
    pub(in crate::backend::ffmpeg) fn from_input(input: AudioResumeWaterlineInput<'_>) -> Self {
    ...
    pub(in crate::backend::ffmpeg) fn below_target(self) -> bool {
        !self.ready
    }

    pub(in crate::backend::ffmpeg) fn reaches_target_with_margin(self, margin: Duration) -> bool {
...
pub(in crate::backend::ffmpeg) struct AudioResumeWaterlineInput<'a> {
    pub(in crate::backend::ffmpeg) pending_audio: &'a PendingStartAudio,
    pub(in crate::backend::ffmpeg) resume_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) delayed_audio_start_timeline_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_output_buffered_until_nsecs: Option<u64>,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct DecodedOutputReadiness {
    pub(in crate::backend::ffmpeg) video_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) delayed_audio_start_gap_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) video_ready: bool,
    pub(in crate::backend::ffmpeg) audio_ready: bool,
}

impl DecodedOutputReadiness {
    pub(in crate::backend::ffmpeg) fn ready(self) -> bool {
        self.video_ready && self.audio_ready
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct PrefetchReadiness {
    pub(in crate::backend::ffmpeg) video_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) audio_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) min_forward_nsecs: Option<u64>,
    pub(in crate::backend::ffmpeg) ready: bool,
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct PlaybackResumeWaterline {
    pub(in crate::backend::ffmpeg) target_nsecs: u64,
    pub(in crate::backend::ffmpeg) audio_resume_waterline: Option<AudioResumeWaterline>,
    pub(in crate::backend::ffmpeg) decoded_output: DecodedOutputReadiness,
    pub(in crate::backend::ffmpeg) prefetch: PrefetchReadiness,
    pub(in crate::backend::ffmpeg) allow_audio_gap_at_video_resume: bool,
    pub(in crate::backend::ffmpeg) resume_anchor_source: ResumeAnchorSource,
}
...
impl PlaybackResumeWaterline {
    pub(in crate::backend::ffmpeg) fn ready(self) -> bool {
        self.decoded_output.ready() && self.prefetch.ready
    }

    pub(in crate::backend::ffmpeg) fn decoded_ready(self) -> bool {
        self.decoded_output.ready()
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct PlaybackResumeWaterlineOptions {
...
pub(in crate::backend::ffmpeg) fn video_output_rebuffer_should_enter(
...
pub(in crate::backend::ffmpeg) fn video_output_underflow_classification(
    output_state: PlaybackOutputState,
    video_bootstrap_after_seek: bool,
    demux_cache_insufficient: bool,
    demux_min_forward_nsecs: Option<u64>,
) -> VideoOutputUnderflowClassification {
    if video_bootstrap_after_seek && output_state.restart_pending() {
...
fn video_output_rebuffer_entry_decision(
    ...
    if context.pending_audio_recoverable {
        return VideoOutputRebufferEntryDecision {
    ...
    let queued_video_near_drain = context.queued_video_forward_nsecs.is_none_or(|duration| {
        duration <= duration_nsecs(VIDEO_OUTPUT_REBUFFER_LOW_WATER_DURATION)
    });
    if !context.render_backlogged
        && context.video_output_underflowing
...
pub(in crate::backend::ffmpeg) fn demux_reader_ready_for_output(
...
pub(in crate::backend::ffmpeg) fn should_block_for_demux_read(
    output_state: PlaybackOutputState,
) -> bool {
...
pub(in crate::backend::ffmpeg) fn video_decode_should_skip_nonref_for_pressure(
    ...
    if !has_audio_output || output_state.restart_pending() {
        return false;
    }
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn video_output_rebuffer_resume_duration(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> Duration {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn video_output_rebuffer_resume_duration_with_resource_pressure(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
...
pub(in crate::backend::ffmpeg) fn video_output_start_prebuffer_duration(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> Duration {
    queued_video_target_duration(queued_video_frames, needs_prefetch)
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn video_output_rebuffer_resume_frames(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> usize {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn video_output_start_prebuffer_frames(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> usize {
    queued_video_target_frames(queued_video_frames, needs_prefetch)
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn video_output_rebuffer_resume_reached(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> bool {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn decoded_video_start_prebuffer_reached(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    needs_prefetch: bool,
) -> bool {
    if queued_video_frames.is_empty() {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn audio_clock_resume_timeline_nsecs(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
...
pub(in crate::backend::ffmpeg) fn rebuffer_audio_clock_resume_decision(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    played_until_nsecs: u64,
    audio_output_buffered_until_nsecs: Option<u64>,
...
pub(in crate::backend::ffmpeg) fn initial_output_sync_decision(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    played_until_nsecs: u64,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn initial_audio_clock_resume_decision(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    played_until_nsecs: u64,
) -> Option<AudioClockResumeDecision> {
...
pub(in crate::backend::ffmpeg) fn audio_output_buffered_until_for_resume(
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn queued_video_forward_nsecs(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
) -> Option<u64> {
...
pub(in crate::backend::ffmpeg) fn decoded_audio_forward_nsecs_from(
    pending_audio: &PendingStartAudio,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn playback_resume_waterline(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_timeline_nsecs: u64,
    demux_watermark: DemuxReaderWatermark,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn rebuffer_playback_resume_waterline(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_timeline_nsecs: u64,
    demux_watermark: DemuxReaderWatermark,
...
#[cfg(test)]
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn rebuffer_playback_resume_waterline_with_resource_pressure(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_timeline_nsecs: u64,
    demux_watermark: DemuxReaderWatermark,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn rebuffer_playback_resume_waterline_for_decision(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_decision: AudioClockResumeDecision,
    demux_watermark: DemuxReaderWatermark,
...
pub(in crate::backend::ffmpeg) fn rebuffer_playback_resume_waterline_after_prolonged_wait(
    ...
    if waterline.ready()
        ...
        || !waterline.prefetch.ready
    {
        return waterline;
    }

    let Some(decoded_video_forward_nsecs) = waterline.decoded_output.video_forward_nsecs else {
        return waterline;
    };
    ...
    waterline.decoded_output.video_ready = true;
    waterline.decoded_output.audio_ready = true;
    waterline
}

pub(in crate::backend::ffmpeg) fn rebuffer_playback_resume_waterline_after_cache_pause(
    mut waterline: PlaybackResumeWaterline,
    rebuffer_wait_elapsed: Option<Duration>,
    cache_paused: bool,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn initial_playback_resume_waterline(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_timeline_nsecs: u64,
...
pub(in crate::backend::ffmpeg) fn playback_resume_waterline_with_target(
    queued_video_frames: &VecDeque<QueuedVideoFrame>,
    pending_audio: &PendingStartAudio,
    resume_timeline_nsecs: u64,
    demux_watermark: DemuxReaderWatermark,
    ...
    PlaybackResumeWaterline {
        ...
        decoded_output: DecodedOutputReadiness {
            video_forward_nsecs: decoded_video_forward_nsecs,
            audio_forward_nsecs: decoded_audio_forward_nsecs,
            delayed_audio_start_gap_nsecs,
            video_ready: decoded_video_ready,
            audio_ready: decoded_audio_ready,
        },
        prefetch: PrefetchReadiness {
            video_forward_nsecs: demux_watermark.video_forward_nsecs,
            audio_forward_nsecs: demux_watermark.audio_forward_nsecs,
            min_forward_nsecs: demux_min_forward_nsecs,
            ready: demux_ready,
        },
...
pub(in crate::backend::ffmpeg) fn playback_resume_waterline_blocked_on(
    waterline: PlaybackResumeWaterline,
) -> PlaybackBlockReason {
    if !waterline.decoded_output.video_ready {
        PlaybackBlockReason::DecodedVideoQueue
    } else if !waterline.decoded_output.audio_ready {
        PlaybackBlockReason::DecodedAudioQueue
    } else if !waterline.prefetch.ready {
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn log_playback_resume_waterline_wait(
    ...
    tracing::debug!(
        ...
        audio_start_gap_ms = ?waterline
            .decoded_output.delayed_audio_start_gap_nsecs
            .map(|gap| gap as f64 / 1_000_000.0),
        ...
        decoded_video_ready = waterline.decoded_output.video_ready,
        decoded_audio_ready = waterline.decoded_output.audio_ready,
        demux_ready = waterline.prefetch.ready,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn enter_video_output_rebuffer(
...
pub(in crate::backend::ffmpeg) fn finish_video_output_rebuffer_if_ready(
    output_state: &mut PlaybackOutputState,
    waterline: PlaybackResumeWaterline,
    session_id: PlaybackSessionId,
) -> bool {
    ...
    *output_state = PlaybackOutputState::Primed;
    tracing::debug!(
        session_id = ?session_id,
        blocked_on = playback_resume_waterline_blocked_on(waterline).as_str(),
        target_ms = waterline.target_nsecs as f64 / 1_000_000.0,
...
pub(in crate::backend::ffmpeg) fn clear_video_output_rebuffer(
    output_state: &mut PlaybackOutputState,
    control: &FfmpegControl,
) {
...
#[cfg(test)]
mod tests {
    use crate::render_host::{DecodedFrame, FramePixels, FramePts, RenderSize};
    ...
    use super::{
        ...
        DEFAULT_VIDEO_FRAME_DURATION_NSECS, DecodedOutputReadiness, DemuxReaderWatermark,
        PendingStartAudio, PlaybackResumeWaterline, PlaybackResumeWaterlineOptions,
        PrefetchReadiness, QueuedVideoFrame, RebufferAudioAnchorResetContext, ResumeAnchorSource,
        ...
        audio_output_buffered_until_for_resume, duration_nsecs,
    ...
    fn rebuffer_waterline(
        ...
        PlaybackResumeWaterline {
            ...
            decoded_output: DecodedOutputReadiness {
                video_forward_nsecs: Some(decoded_video_forward_nsecs),
                audio_forward_nsecs: Some(decoded_audio_forward_nsecs),
                delayed_audio_start_gap_nsecs: None,
                video_ready: decoded_video_forward_nsecs
                    >= duration_nsecs(VIDEO_OUTPUT_REBUFFER_RESUME_DURATION),
                audio_ready: decoded_audio_forward_nsecs
                    >= duration_nsecs(VIDEO_OUTPUT_REBUFFER_RESUME_DURATION),
            },
            prefetch: PrefetchReadiness {
                video_forward_nsecs: Some(demux_forward_nsecs),
                audio_forward_nsecs: Some(demux_forward_nsecs),
                min_forward_nsecs: Some(demux_forward_nsecs),
                ready: demux_ready,
            },
            allow_audio_gap_at_video_resume: false,
            resume_anchor_source: ResumeAnchorSource::Video,
    ...
    fn prolonged_rebuffer_wait_does_not_relax_demux_waterline() {
        ...
        assert!(!waterline.decoded_output.audio_ready);
        assert_eq!(waterline.prefetch.min_forward_nsecs, Some(0));
    }
