...
pub(in crate::backend::ffmpeg) struct PendingAudioUnderrunRecoveryPlan {
    pub(in crate::backend::ffmpeg) audio_start_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) audio_flush_until_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg) reset_audio_to_timeline_nsecs: Option<u64>,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum DelayedAudioStartSilencePolicy {
    Allow,
    Skip,
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct AudioStageResult {
    pub(in crate::backend::ffmpeg) made_progress: bool,
    pub(in crate::backend::ffmpeg) staged_frames: usize,
    pub(in crate::backend::ffmpeg) staged_samples: usize,
    pub(in crate::backend::ffmpeg) staged_range_nsecs: Option<(u64, u64)>,
    pub(in crate::backend::ffmpeg) interrupted: bool,
    pub(in crate::backend::ffmpeg) would_block: bool,
    pub(in crate::backend::ffmpeg) timeline_gap_nsecs: Option<(u64, u64)>,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) enum AudioStageCheckpoint {
    PendingPopped(usize),
    FirstEnqueued,
}
...
pub(in crate::backend::ffmpeg) fn pending_audio_underrun_recovery_plan(
...
pub(in crate::backend::ffmpeg) fn discard_stale_pending_audio_before_recovery_start(
...
pub(in crate::backend::ffmpeg) fn flush_pending_start_audio(
    pending_audio: &mut PendingStartAudio,
    output: &AudioOutput,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn stage_pending_audio(
    pending_audio: &mut PendingStartAudio,
    output: &AudioOutput,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn stage_pending_audio_with_checkpoint(
    pending_audio: &mut PendingStartAudio,
    output: &AudioOutput,
    expected_audio_epoch: u64,
    audio_start_timeline_nsecs: u64,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn recover_pending_start_audio_after_underrun(
    pending_audio: &mut PendingStartAudio,
    output: &AudioOutput,
    control: &FfmpegControl,
    queued_video_frames: &mut ScheduledVideoQueue,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn push_decoded_audio_to_output(
    output: &AudioOutput,
    control: &FfmpegControl,
    audio: DecodedAudio,
    start_timeline_nsecs: u64,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn service_audio_clocked_video_queue(
    output: &AudioOutput,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::backend::ffmpeg) fn drain_audio_clocked_decoded_video_step<F>(
    queued_video_frames: &mut ScheduledVideoQueue,
