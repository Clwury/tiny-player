...
pub(in crate::backend::ffmpeg) fn trim_overlapping_subtitle_cues_at(
...
pub(in crate::backend::ffmpeg) fn rebase_subtitle_cues_to_timeline_origin(
    cues: &mut VecDeque<BackendSubtitleCue>,
...
pub(in crate::backend::ffmpeg) fn subtitle_cue_timeline_nsecs(
...
pub(in crate::backend::ffmpeg) fn subtitle_timestamp_to_timeline_nsecs(
    timestamp_nsecs: u64,
