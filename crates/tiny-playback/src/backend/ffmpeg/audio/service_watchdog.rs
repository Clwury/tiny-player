...
#[repr(usize)]
pub(in crate::backend::ffmpeg) enum AudioOutputServiceStage {
    StatusSnapshot = 0,
    StableSnapshot = 1,
    ResetClock = 2,
    StagePending = 3,
...
pub(in crate::backend::ffmpeg::audio) struct AudioOutputServiceTelemetry {
    origin: Instant,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::backend::ffmpeg) struct AudioOutputServiceStageSnapshot {
    pub(in crate::backend::ffmpeg) stage: AudioOutputServiceStage,
    pub(in crate::backend::ffmpeg) active: bool,
    pub(in crate::backend::ffmpeg) active_elapsed_nsecs: u64,
    pub(in crate::backend::ffmpeg) last_elapsed_nsecs: u64,
    pub(in crate::backend::ffmpeg) started_count: u64,
    pub(in crate::backend::ffmpeg) completed_count: u64,
}

pub(in crate::backend::ffmpeg) struct AudioOutputServiceStageGuard {
...
impl AudioOutputServiceTelemetry {
    ...
    pub(in crate::backend::ffmpeg::audio) fn begin(
        self: &Arc<Self>,
        stage: AudioOutputServiceStage,
    ...
    pub(in crate::backend::ffmpeg::audio) fn snapshots(
        &self,
...
pub(in crate::backend::ffmpeg::audio) fn spawn_audio_output_service_watchdog(
    telemetry: Arc<AudioOutputServiceTelemetry>,
