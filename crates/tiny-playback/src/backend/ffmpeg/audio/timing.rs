...
pub(in crate::backend::ffmpeg::audio) struct AudioOutputTryPushTimedTiming {
    pub(in crate::backend::ffmpeg::audio) result: &'static str,
    pub(in crate::backend::ffmpeg::audio) total: Duration,
    pub(in crate::backend::ffmpeg::audio) queue_lock_wait: Duration,
    pub(in crate::backend::ffmpeg::audio) sample_count: usize,
    pub(in crate::backend::ffmpeg::audio) misaligned_audio_buffer_count: u64,
    pub(in crate::backend::ffmpeg::audio) start_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg::audio) end_timeline_nsecs: u64,
    pub(in crate::backend::ffmpeg::audio) queued_frames: usize,
    pub(in crate::backend::ffmpeg::audio) queued_duration: Duration,
}

pub(in crate::backend::ffmpeg::audio) struct AudioOutputSnapshotTiming {
    pub(in crate::backend::ffmpeg::audio) total: Duration,
    pub(in crate::backend::ffmpeg::audio) shared_snapshot: Duration,
    pub(in crate::backend::ffmpeg::audio) queue_snapshot: Duration,
    pub(in crate::backend::ffmpeg::audio) underrun_recheck: Duration,
    pub(in crate::backend::ffmpeg::audio) misaligned_audio_buffer_count: u64,
    pub(in crate::backend::ffmpeg::audio) snapshot: AudioOutputSnapshot,
}

pub(in crate::backend::ffmpeg::audio) fn log_audio_output_try_push_timed_timing(
...
pub(in crate::backend::ffmpeg::audio) fn log_audio_output_reset_clock_timing(
    timeline_nsecs: u64,
    total: Duration,
...
pub(in crate::backend::ffmpeg::audio) fn log_audio_output_snapshot_timing(
...
pub(in crate::backend::ffmpeg::audio) fn log_audio_shared_snapshot_timing(
    total: Duration,
...
pub(in crate::backend::ffmpeg::audio) fn log_audio_queue_snapshot_timing(
    total: Duration,
    lock_wait: Duration,
...
pub(in crate::backend::ffmpeg::audio) fn log_audio_shared_reset_clock_timing(
    timeline_nsecs: u64,
    total: Duration,
    buffer_lock_wait: Duration,
    buffer_cleared: bool,
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn audio_samples_duration(
    samples: usize,
    sample_rate: c_int,
    channels: c_int,
) -> Duration {
...
pub(in crate::backend::ffmpeg) fn audio_elements_duration(
    elements: usize,
    sample_rate: c_int,
    channels: c_int,
) -> Duration {
...
pub(in crate::backend::ffmpeg) fn duration_for_audio_frames(
    frames: u64,
    sample_rate: c_int,
) -> Duration {
...
pub(in crate::backend::ffmpeg::audio) fn interpolated_audio_timeline_nsecs(
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn samples_for_duration(
    timeline_nsecs: u64,
    sample_rate: c_int,
    channels: c_int,
) -> u64 {
...
pub(in crate::backend::ffmpeg) fn audio_elements_for_duration_floor(
    timeline_nsecs: u64,
    sample_rate: c_int,
    channels: c_int,
) -> u64 {
...
#[cfg(test)]
pub(in crate::backend::ffmpeg) fn audio_elements_for_duration_round(
    timeline_nsecs: u64,
    sample_rate: c_int,
    channels: c_int,
) -> u64 {
...
pub(in crate::backend::ffmpeg) fn audio_frames_for_duration_floor(
    timeline_nsecs: u64,
    sample_rate: c_int,
) -> u64 {
...
pub(in crate::backend::ffmpeg) fn audio_frames_for_duration_round(
    timeline_nsecs: u64,
    sample_rate: c_int,
) -> u64 {
    if timeline_nsecs == 0 || sample_rate <= 0 {
...
pub(in crate::backend::ffmpeg) fn audio_elements_for_frames(frames: u64, channels: c_int) -> u64 {
...
pub(in crate::backend::ffmpeg) fn audio_frames_for_elements(
    elements: usize,
    channels: c_int,
) -> u64 {
...
pub(in crate::backend::ffmpeg) fn align_audio_elements_to_frame_boundary(
    elements: usize,
    channels: c_int,
) -> usize {
    if elements == 0 || channels <= 0 {
