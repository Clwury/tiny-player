...
pub(in crate::backend::ffmpeg::audio) struct AudioDeviceCandidate {
    pub(in crate::backend::ffmpeg::audio) source: &'static str,
    pub(in crate::backend::ffmpeg::audio) name: String,
    pub(in crate::backend::ffmpeg::audio) device: cpal::Device,
}
...
pub(in crate::backend::ffmpeg::audio) fn output_device_candidates(
    host: &cpal::Host,
