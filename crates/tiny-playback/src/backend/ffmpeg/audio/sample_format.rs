...
pub(in crate::backend::ffmpeg) fn frame_sample_format(
...
pub(in crate::backend::ffmpeg) fn audio_sample_len(
    samples: c_int,
    channels: c_int,
...
pub(in crate::backend::ffmpeg) fn audio_elements_for_frames_checked(
    frames: c_int,
    channels: c_int,
) -> std::result::Result<usize, String> {
...
pub(in crate::backend::ffmpeg) fn zeroed_channel_layout() -> ffi::AVChannelLayout {
