...
impl RetainedPlaybackSpliceSource {
    pub(in crate::backend::ffmpeg::avio::cache) fn split_prepared_pages(
        &mut self,
    ) -> PreparedByteAppend {
...
impl HttpRingCacheState {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn append_at(&mut self, offset: u64, data: &[u8]) -> bool {
        let prepared = PreparedByteAppend::from_bytes(data);
        self.append_prepared_at(offset, data, prepared)
    }

    #[cfg(test)]
    pub(in crate::backend::ffmpeg::avio::cache) fn append_prepared_at(
        &mut self,
        offset: u64,
        data: &[u8],
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn append_prepared_at_after_disk_write(
        &mut self,
        offset: u64,
        data: &[u8],
        prepared: PreparedByteAppend,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn maybe_queue_playback_continuation(&mut self) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn playback_continuation_prefetch_offset(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn splice_retained_playback_at_active_end(
        &mut self,
        offset: u64,
    ) -> Option<u64> {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn take_retained_playback_splice_source(
        &mut self,
        offset: u64,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn restore_retained_playback_splice_source(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn finish_retained_playback_splice(
        &mut self,
        offset: u64,
        source: RetainedPlaybackSpliceSource,
        prepared: PreparedByteAppend,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn append_retained_at(
        &mut self,
        offset: u64,
        data: &[u8],
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn append_retained_at_protected(
        &mut self,
        offset: u64,
        data: &[u8],
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg::avio::cache) fn append_retained_prepared_at_protected(
        &mut self,
        offset: u64,
        data: &[u8],
        prepared: PreparedByteAppend,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn append_retained_prepared_at_protected_after_disk_write(
        &mut self,
        offset: u64,
        data: &[u8],
        prepared: PreparedByteAppend,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn retained_range_index_for_append(
        &self,
        offset: u64,
        range_kind: HttpCacheRangeKind,
    ) -> Option<usize> {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn record_input_bytes(&mut self, bytes: usize) {
        if bytes == 0 {
            return;
        }
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn raw_input_rate(&self) -> Option<u64> {
        let now = Instant::now();
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn adaptive_input_rate(&self) -> Option<u64> {
        let now = Instant::now();
        let first = self
            .input_rate_samples
            .iter()
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn prune_input_rate_samples(&mut self) {
        let now = Instant::now();
        while self
            .input_rate_samples
            .front()
    ...
    pub(in crate::backend::ffmpeg) fn trim_to_capacity(&mut self, capacity: usize) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn trim_retained_ranges_to_capacity(
        &mut self,
        capacity: usize,
    ) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn trim_retained_ranges_to_capacity_preserving(
        &mut self,
        capacity: usize,
        protected: &[CacheRestartRequest],
    ) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn retained_memory_bytes(&self) -> usize {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn target_readahead_bytes(&self) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn resume_readahead_bytes(
        &self,
        target: u64,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn side_retain_reserve_bytes(&self) -> usize {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn active_memory_capacity(&self) -> usize {
        if self.active_range_kind == HttpCacheRangeKind::Playback {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn retained_capacity_with_side_reserve(
        &self,
        protected: bool,
    ) -> usize {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn side_range_request_bytes(
        &self,
        range_kind: HttpCacheRangeKind,
    ) -> u64 {
