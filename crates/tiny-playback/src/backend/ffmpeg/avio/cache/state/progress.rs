...
impl HttpRingCacheState {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn stream_buffer_progress(
        &self,
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn playback_buffer_range(
        &self,
...
pub(in crate::backend::ffmpeg::avio::cache) fn playback_buffer_range(
    base_offset: u64,
    next_offset: u64,
    content_len: u64,
) -> Option<HttpPlaybackBufferRange> {
...
pub(in crate::backend::ffmpeg::avio::cache) fn merge_playback_buffer_ranges(
...
pub(in crate::backend::ffmpeg::avio::cache) fn merged_cached_byte_len(
