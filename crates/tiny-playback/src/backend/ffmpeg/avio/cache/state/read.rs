...
impl HttpRingCacheState {
    pub(in crate::backend::ffmpeg::avio::cache) fn read_wait_observation(
        &self,
        current_offset: u64,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn observe_read_wait_log(
        &mut self,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn set_read_error(
        &mut self,
        offset: u64,
        message: String,
    ) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn read_error_at(
        &self,
        offset: u64,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn clear_read_error_covered_by(
        &mut self,
        offset: u64,
        len: usize,
    ) {
    ...
    pub(in crate::backend::ffmpeg) fn copy_available(
        &mut self,
        offset: u64,
        output: &mut [u8],
    ) -> Option<usize> {
    ...
    pub(in crate::backend::ffmpeg) fn set_reader_offset(&mut self, offset: u64) {
    ...
    pub(in crate::backend::ffmpeg) fn note_seek_offset(
        &mut self,
        offset: u64,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn expire_short_seek(&mut self) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn demote_active_range_to_retained(&mut self) {
...
pub(in crate::backend::ffmpeg::avio::cache) fn copy_available_from_range(
