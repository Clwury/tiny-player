...
impl HttpRingCacheState {
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn restart_at(&mut self, offset: u64) {
        self.restart_at_with_kind(offset, HttpCacheRangeKind::Playback);
    }

    pub(in crate::backend::ffmpeg) fn restart_at_with_kind(
        &mut self,
        offset: u64,
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn retain_current_range_for_restart(
        &mut self,
        offset: u64,
    ) {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn next_retained_access_generation(
        &mut self,
    ) -> u64 {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn queue_read_miss_at(
        &mut self,
        offset: u64,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn range_kind_for_miss(
        &self,
        offset: u64,
    ) -> HttpCacheRangeKind {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn take_range_kind_for_miss(
        &mut self,
        offset: u64,
    ) -> HttpCacheRangeKind {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn request_side_download_at(
        &mut self,
        offset: u64,
        range_kind: HttpCacheRangeKind,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn request_playback_continuation_at(
        &mut self,
        offset: u64,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn stale_playback_continuation_offset(
        &self,
        offset: u64,
    ) -> bool {
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn side_download_may_produce(
        &self,
        offset: u64,
    ) -> bool {
        self.side_download_requests
    ...
    pub(in crate::backend::ffmpeg::avio::cache) fn schedule_playback_continuation_after_side_download(
        &mut self,
        request: CacheRestartRequest,
    ) {
    ...
    #[cfg(test)]
    pub(in crate::backend::ffmpeg) fn buffered_ahead_from(&self, offset: u64) -> u64 {
