...
use crate::backend::{PlaybackCacheConfig, PlaybackCacheMode};
...
impl HttpCacheConfig {
    pub(in crate::backend::ffmpeg::avio::cache) fn from_playback_config(
        ...
        Self {
            ...
            cache_dir: config.cache_directory("TINY_HTTP_CACHE_DIR"),
            unlink_files: config.unlink_files,
        }
    }

    #[cfg(test)]
    pub(in crate::backend::ffmpeg::avio::cache) fn for_test(memory_capacity: usize) -> Self {
        Self {
            memory_capacity,
